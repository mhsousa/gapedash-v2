...
with tab5:
    ...
    st.markdown("""<h3 style="font-family: Candara;">Taxa de Criação e de Destruição  de Empregos por Setor.</h3>""", unsafe_allow_html=True)
    st.write("")
    st.dataframe(criac_emp)
    st.divider()
    st.markdown("""<h3 style="font-family: Candara;">Impacto (p.p.) dos preços de grupos de produtos e serviços sobre a inflação mensal - Slz.</h3>""", unsafe_allow_html=True)
    st.write("")
    st.dataframe(inf_mens)
    st.divider()
    st.markdown("""<h3 style="font-family: Candara;">Rendimento habitual médio real e Proporção do Rendimento das Mulheres – MA.</h3>""", unsafe_allow_html=True)
    st.write("")
    st.dataframe(rend_hab)
    st.divider()
    st.markdown("""<h3 style="font-family: Candara;">Taxa de Desemprego Real</h3>""", unsafe_allow_html=True)
    st.write("")
    st.dataframe(desoc)
    st.divider()
    st.markdown("""<h3 style="font-family: Candara;">Índice GINI da renda domiciliar per capita e Gini Média Móvel.</h3>""", unsafe_allow_html=True)
    st.write("")
    st.dataframe(desig)
