...
with tab1:
    ...
    st.divider()
    st.plotly_chart(fig13,config={'modeBarButtonsToRemove': ['toImage', 'zoom2d', 'select2d', 'lasso2d','zoom', 'autoScale2d', 'hoverClosestCartesian', 'hoverCompareCartesian', 'toggleSpikes', 'resetScale2d', 'pan2d', 'zoomIn2d', 'zoomOut2d', 'editTrace', 'annotationEdit', 'eye', 'modeBar', 'select', 'lasso']})
    st.markdown("""
