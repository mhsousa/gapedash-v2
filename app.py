...
impacto, considerando toda a série temporal.
    ...
    st.markdown("""
	<p style='font-family: Arial, sans-serif; font-size: 16px;text-align: justify;'>
	   <b>Nota Técnica sobre o gráfico 16</b>:<br><br>O impacto das despesas de transporte na inflação em São Luís, mede o
