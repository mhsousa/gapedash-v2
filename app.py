...
with tab1:
    ...
    st.divider()
    st.plotly_chart(fig13, use_container_width=True, config={'scrollZoom': True,'modeBarButtonsToRemove': ['toggleFullscreen','zoom2d', 'pan2d','zoom', 'pan', 'select', 'lasso', 'zoomIn', 'zoomOut', 'autoScale', 'hoverClosest', 'toggleSpikes', 'resetScale', 'hoverCompareCartesian', 'hoverCompareGL', 'toImage', 'sendDataToCloud', 'editInChartStudio', 'lasso2d', 'select2d', 'zoomIn2d', 'zoomOut2d', 'autoScale2d', 'hoverClosestCartesian', 'hoverCompareCartesian']})
    st.markdown("""
